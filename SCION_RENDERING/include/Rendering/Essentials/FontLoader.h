...
class FontLoader
{
  public:
	...
	* @param A string for the font path, a float for the font's size, and the width and height of the generated font texture.
	...
	*/
	...
	/*
	 * @brief Creates a shared ptr to a Font class based on the passed in params.
	 * @param A const unsigned char* for the fontData. This is data that has been converted from a ttf file to a char array.
