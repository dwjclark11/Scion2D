...
std::string Scion::Core::ECS::CircleColliderComponent::to_string() const
{
	std::stringstream ss;
...
void Scion::Core::ECS::CircleColliderComponent::CreateLuaCircleColliderBind( sol::state& lua )
{
