...
namespace SCION_CORE::Scripting {
	...
	void CreateVec2Bind(sol::state& lua)
	{
		...
		lua.new_usertype<glm::vec2>(
			...
			"nearly_zero_x", [](const glm::vec2& v) { return glm::epsilonEqual(v.x, 0.f, 0.001f); },
			"nearly_zero_y", [](const glm::vec2& v) { return glm::epsilonEqual(v.y, 0.f, 0.001f); }
		);
	}
	...
	void CreateVec3Bind(sol::state& lua)
	{
		...
		lua.new_usertype<glm::vec3>(
			...
			"nearly_zero_x", [](const glm::vec3& v) { return glm::epsilonEqual(v.x, 0.f, 0.001f); },
			"nearly_zero_y", [](const glm::vec3& v) { return glm::epsilonEqual(v.y, 0.f, 0.001f); },
			"nearly_zero_z", [](const glm::vec3& v) { return glm::epsilonEqual(v.z, 0.f, 0.001f); }
		);
	}
	...
	void CreateVec4Bind(sol::state& lua)
	{
		...
		lua.new_usertype<glm::vec4>(
			...
			"nearly_zero_x", [](const glm::vec4& v) { return glm::epsilonEqual(v.x, 0.f, 0.001f); },
			"nearly_zero_y", [](const glm::vec4& v) { return glm::epsilonEqual(v.y, 0.f, 0.001f); },
			"nearly_zero_z", [](const glm::vec4& v) { return glm::epsilonEqual(v.z, 0.f, 0.001f); },
			"nearly_zero_w", [](const glm::vec4& v) { return glm::epsilonEqual(v.w, 0.f, 0.001f); }
		);
	}
