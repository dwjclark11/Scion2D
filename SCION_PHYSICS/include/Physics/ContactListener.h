...
class ContactListener : public b2ContactListener
{
  ...
  public:
	...
	* @brief Note: the contact manifold does not include time of impact impulses, which can be arbitrarily large if the sub-step is small.
	...
	*/
	...
	/*
	* @brief This is called after a contact is updated. This allows you to inspect a contact before it goes to the solver.
