...
void ImGui::TableHeader( const char* label )
{
	...
	RenderTextEllipsis(
		window->DrawList, label_pos, ImVec2( ellipsis_max, bb.Max.y ), ellipsis_max, label, label_end, &label_size );
		...
		for ( int order_n = 0; order_n < data_count; order_n++ )
		{
			...
			if ( pass == 0 )
			{
				...
				while ( label_name < label_name_end )
				{
					...
					RenderTextEllipsis(
						draw_list, clip_r.Min, clip_r.Max, clip_r.Max.x, label_name, label_name_eol, &label_size );
					PopStyleColor();
