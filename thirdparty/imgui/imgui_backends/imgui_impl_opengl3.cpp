...
//  (ImGuiBackendFlags_RendererHasVtxOffset) [Desktop OpenGL only!] [X] Renderer: Multi-viewport support (multiple
...
void ImGui_ImplOpenGL3_RenderDrawData( ImDrawData* draw_data )
{
	...
	for ( int n = 0; n < draw_data->CmdListsCount; n++ )
	{
		...
		if ( bd->UseBufferSubData )
		{
			...
			GL_CALL( glBufferSubData(
				GL_ELEMENT_ARRAY_BUFFER, 0, idx_buffer_size, (const GLvoid*)draw_list->IdxBuffer.Data ) );
		}
		else
		{
	...
	glScissor(
		last_scissor_box[ 0 ], last_scissor_box[ 1 ], (GLsizei)last_scissor_box[ 2 ], (GLsizei)last_scissor_box[ 3 ] );
