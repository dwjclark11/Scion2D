...
class SceneObject : public Scion::Core::Scene
{
  public:
	SceneObject( const std::string& sceneName, Scion::Core::EMapType eType = Scion::Core::EMapType::Grid );
	 ...
	 */
	void CopyPlayerStartToRuntimeRegistry( Scion::Core::ECS::Registry& runtimeRegistry );
  ...
  private:
	...
	Scion::Core::ECS::Registry m_RuntimeRegistry;
