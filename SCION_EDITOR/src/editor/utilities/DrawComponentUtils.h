...
class DrawComponentsUtil
{
  public:
	...
	template <typename TComponent>
	static void DrawComponentInfo( SCION_CORE::ECS::Entity& entity, TComponent& component );
  ...
  private:
	...
	static void DrawImGuiComponent( SCION_CORE::ECS::Entity& entity, SCION_CORE::ECS::TransformComponent& transform );
	static void DrawImGuiComponent( SCION_CORE::ECS::Entity& entity, SCION_CORE::ECS::SpriteComponent& sprite );
	static void DrawImGuiComponent( SCION_CORE::ECS::Entity& entity, SCION_CORE::ECS::AnimationComponent& animation );
	static void DrawImGuiComponent( SCION_CORE::ECS::Entity& entity,
									SCION_CORE::ECS::BoxColliderComponent& boxCollider );
	static void DrawImGuiComponent( SCION_CORE::ECS::Entity& entity,
									SCION_CORE::ECS::CircleColliderComponent& circleCollider );
	static void DrawImGuiComponent( SCION_CORE::ECS::Entity& entity, SCION_CORE::ECS::PhysicsComponent& physics );
	static void DrawImGuiComponent( SCION_CORE::ECS::Entity& entity, SCION_CORE::ECS::RigidBodyComponent& rigidbody );
	static void DrawImGuiComponent( SCION_CORE::ECS::Entity& entity, SCION_CORE::ECS::TextComponent& textComponent );
	static void DrawImGuiComponent( SCION_CORE::ECS::Entity& entity, SCION_CORE::ECS::Identification& identification );
};
